/**
 * SOCO Ukraine — особистий кабінет (демо, дані в localStorage).
 */
(function () {
  'use strict';
  ...
  function fillAccount(u) {
    ...
    $('[data-stat-discount]').textContent = spent > 50000 ? '15 %' : spent > 20000 ? '10 %' : '5 %';
    ...
    /* --- Адреси --- */
    const addresses = [
      { title: 'Клініка, основна', text: 'м. Київ, вул. Антоновича, 44, оф. 210', note: 'Курʼєр, Пн–Пт 9:00–18:00', main: true },
